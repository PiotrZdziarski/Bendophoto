...
@section('content')
  ...
  <div class="container">
    <br>
    <span class="explorespan">Explore:</span>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="width:80%; top:3%; margin-bottom: 3%;">
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                            @if($post->type == 'Photo')
                              <img src='{{Asset("storage/images/$post->autorpost/$post->post")}}' class="imagingsmalldevice">
                            @endif

                            @if($post->type == "Video")
                              <video controls  class="imagingsmalldevice">
                                <source src="{{Asset("storage/images/$post->autorpost/".$post->post)}}">
                              </video>
                            @endif
