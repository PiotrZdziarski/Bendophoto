          ...
          <div class="form-group row" style="padding:0; margin:0;">
            <div id="loggeduser" style="min-width: 145px;">
                ...
                <div style="padding-right: 15%; ">
                    ...
                    @if($profileimagename == '' || $profileimagename == null)
                        ...
                        <label for="file-input">
                            <img class="rounded" src="{{Asset('storage/images/nonepicture.png')}}" id="profilepicture" style="cursor:pointer;">
                        </label>
                        <!-- Button trigger modal -->
                          <button type="button" class="btn btn-primary" id="file-input" style="display:none;" data-toggle="modal" data-target="#exampleModalCenter"></button>

                          <!-- Modal -->
                          <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content">
                                <form method="post" action="{{Route('addingprofilepicture')}}" enctype="multipart/form-data">
                                  <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalCenterTitle">Set profile picture</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
                                  <div class="modal-body">
                                    We support formats: .jpg, .png, .bmp

                                      @csrf
                                      <input type="file" accept="image/*" name="profilepicture" class="form-control" style="margin-top: 10px;">
                                  </div>
                    ...
                    @if($profileimagename != '' || $profileimagename != null)
                      <label for="file-input">
                          <img class="rounded" src='{{Asset("storage/images/$profilename/$profileimagename")}}' id="profilepicture" style="cursor:pointer;">
                      </label>
                      <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary" id="file-input" style="display:none;" data-toggle="modal" data-target="#exampleModalCenter"></button>

                        <!-- Modal -->
                        <div class="modal fade" style="overflow-y:scroll;" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <form method="post" action="{{Route('addingprofilepicture')}}" enctype="multipart/form-data">
                                <div class="modal-header">
              ...
              <div style="width: 59%;">
                ...
                <br><a href="{{Route('editprofile')}}"><button type="button" id="btneditprofile">Edit profile</button></a>
                  ...
                  <nav class="navbar-light navbar-laravel navbar navbar-expand-md" style="padding-right:0;">
                      ...
                      <div class="collapse navbar-collapse"  id="profileContent" style="padding-top: 10px;">
                            ...
                            <span style="width: 100%;">
                              ...
                              <br><br>
                                ...
                                <a class="posts">Followers: {{$followers}}</a>
                              <br><br>
                                <a>{{$description}}</a>
		...
		<div class="row">
			<div class="col-xs-12 col-md-10" style="margin-left:auto; margin-right:auto; padding:0;">
				<nav>
					<div class="nav nav-tabs" id="nav-tab" role="tablist" style="margin-bottom: 20px;">
						<a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true" style="margin-left:auto;">Posts</a>
						<a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false" style="margin-right:auto;">Saved</a>
					</div>
				</nav>
                  ...
                  @if($post->type == 'Photo')
                    <div class="centeringvertically">
                      <label for="button{{$post->id}}" class="labelpost">
                        ...
                        <img src='{{Asset("storage/images/$loggeduser/$post->post")}}' id="posting{{$post->id}}" class="postphoto">
                      </label>
                    </div>
                  @endif
                  @if($post->type == "Video")
                  ...
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="width:80%; top:3%; margin-bottom: 3%;">
                    <div class="modal-content">
                      ...
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="width: 5%; margin-left:93%;position: absolute;padding:0;">
                        ...
                        <div class="modal-body">
                          @if($post->type == 'Photo')
                            <img src='{{Asset("storage/images/$loggeduser/$post->post")}}' class="imagingsmalldevice">
                          @endif

                          @if($post->type == "Video")
                            <video controls  class="imagingsmalldevice">
                              <source src="{{Asset("storage/images/$loggeduser/".$post->post)}}">
                            </video>
                          @endif
                            ...
                            <span class="float-left" id="likes_span{{$post->id}}" style="font-weight: 700; margin-top: 7px; margin-left: 5px;font-size: 16px;"> {{$post->likes}}</span>
                              ...
                              <br><br><div class="linebreaker"><br></div>
                                <span class="textpost">{{$post->textpost}}s daslk daslkdn alskn daksl dnalksnd lkasnd lkasn dklasn ldkanslkd naslkdn aslknd aslknd akslnd laksn dklansd asndk ansd naskdnaslknd</span>
                              <br>
            ...
            @endforeach
					...
					<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
						<a style="text-align:center;font-size: 32px; color:dodgerblue; display:block;">Incoming soon!</a>
					</div>
				</div>
